...
- recurring objects and consequences.

Cases supply problems for the office. They do not need to replace the player's cast.
...
- required deductions;
- victim status;
- canonical outcome conditions.

## Player Moments

During play, retain only a few events worth discussing afterward:
...
Do not prescribe what the player is supposed to feel.
...
> You dismissed the blue scarf immediately. I thought you were being careless. You were right.
...
- epilogue variation;
- newspaper clipping;
- recovered object on the desk;
- recurring inside joke;
- future contact or ally.
